...
class DDPG:
    ...
    def step(self,state,reward):
        ...
        print("Action: ", action, " Reward: ", round(reward,2))
    ...
    def newEpisode(self):
        ...
        normalized_Reward = self.episodic_reward/self.Episode_Length
        self.ep_reward_list.append(normalized_Reward)
        avg_reward = np.mean(self.ep_reward_list[-40:])
        print("Episode * {} * Reward is ==> {} * Avg Reward is ==> {}".format(self.ep, normalized_Reward, avg_reward))
        self.ep += 1
